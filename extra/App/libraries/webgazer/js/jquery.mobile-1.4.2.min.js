  ...
  !(function (a) {
    ...
    (function (a, b) {
      var d = function (b, c) {
        ...
        return (
          0 === g.length && f.length > 0 && (e = e.concat(f.toArray())),
    ...
    (function (a, b) {
      ...
      a.each(["animation", "transition"], function (c, g) {
        ...
        (a.fn.animationComplete = function (e, f, g) {
          ...
          return (a.support.cssTransitions && "transition" === k) ||
            (a.support.cssAnimations && "animation" === k)
            ? (g === b &&
                (a(this).context !== c &&
                  (i = 3e3 * parseFloat(a(this).css(d[k].duration))),
                (0 === i || i === b || isNaN(i)) &&
              ...
              : (this._getBase().reset(),
                k.length && !j.reload
                  ? (this._enhance(k, j.role),
                    i.resolve(l, j, k),
                    void (j.prefetch || this._getBase().set(b)))
                  : ((h = {
                      url: b,
                      absUrl: l,
                      dataUrl: f,
        ...
        (a.mobile._registerInternalEvents = function () {
          var e = function (b, c) {
            ...
            return !a.mobile.ajaxEnabled ||
              ...
              b.attr("target")
              ? !1
              : ((d = (h && h.attr("formaction")) || b.attr("action")),
                ...
                !a.mobile.path.isPermittedCrossDomainRequest(g, d)
                  ? !1
                  : (c ||
                      ((e = b.serializeArray()),
                      h &&
                        ...
                        f &&
                          ...
                          f && e.push({ name: f, value: h.attr("value") }))),
                      (j = {
                        url: d,
                        options: {
                          type: i,
          ...
          a.mobile.document.delegate("form", "submit", function (b) {
                ...
                if (
                  ...
                  if (-1 !== h.search("#")) {
                    ...
                    h = a.mobile.path.isPath(h)
                      ? a.mobile.path.makeUrlAbsolute(h, f)
                      : a.mobile.path.makeUrlAbsolute("#" + h, g.hrefNoHash);
                  }
                  if (
                    ((i =
                      o.is("[rel='external']") ||
                    ...
                    (j =
                      ...
                      (a.mobile.path.isExternal(h) &&
                        !a.mobile.path.isPermittedCrossDomainRequest(g, h))))
                  )
                    return void p();
            ...
            a.mobile.document.bind("pageshow", function () {
              f
                ? f.done(a.mobile.resetActivePageHeight)
        ...
        a.extend(
          {
            ...
            _create: function () {
              ...
              ("checkbox" === h || "radio" === h) &&
                ...
                (d.iconpos =
                  e(b, "iconpos") ||
                  g.attr("data-" + a.mobile.ns + "iconpos") ||
                  d.iconpos),
                (d.mini = e(b, "mini") || d.mini),
                a.extend(this, {
                  input: b,
                  label: g,
                  parentLabel: f,
        ...
        build: function () {
          ...
          return w.nativeMenu
            ...
            : ((v = this),
              ...
              (i = c + "-menu"),
              (j = w.theme
                ? " data-" + a.mobile.ns + "theme='" + w.theme + "'"
                : ""),
    ...
    (function (a, c) {
      a.widget("mobile.panel", {
        ...
        _handleClick: function (b) {
          ...
          return b.currentTarget.href.split("#")[1] === e && e !== c
            ? (b.preventDefault(),
              (d = a(b.target)),
              d.hasClass("ui-btn") &&
        ...
        _bindPageEvents: function () {
          ...
          this.document
            ...
            this._parentPage ||
              ...
              this._on(this.document, { pageshow: "_getWrapper" }),
            a._parentPage
              ? this.document.on(
                  "pagehide",
                  ":jqmData(role='page')",
              ...
              e = function () {
                c.document.off("panelclose"),
                  ...
                  !b && a.support.cssTransform3d && d.animate
                    ? c.element.animationComplete(f, "transition")
                    : setTimeout(f, 0),
                  d.theme &&
                    "overlay" !== d.display &&
                    c
          ...
          if (e) {
            ...
            this._timer && (b.clearTimeout(this._timer), (this._timer = 0)),
              (this._timer = this._delay(function () {
                this._trigger("beforefilter", null, { input: e }),
